...
import { Menu, Bell, ChevronDown, User, Settings, HelpCircle, LogOut, Sliders } from 'lucide-react';
  ...
  return (
    <header className="flex h-16 items-center gap-3 border-b border-border bg-card/80 px-4 backdrop-blur-sm lg:px-6">
      ...
      <div className="hidden items-center gap-2 text-sm text-muted-foreground sm:flex">
        <span className="font-medium text-foreground">CONTROLPLANE</span>
      ...
      <div className="ml-auto flex items-center gap-2">
        <Popover>
          ...
          <PopoverContent align="end" className="w-72">
            <div className="space-y-3">
              <div className="text-sm font-semibold">Environment Status</div>
              <div className="space-y-2 text-sm">
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Environment</span>
                  <span className="font-medium">Production (Demo)</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">Prototype / Simulated</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2 rounded-lg border border-border p-3">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-medium">Human review required</div>
                      <div className="text-xs text-muted-foreground">
                        {pendingCount} evaluation{pendingCount > 1 ? 's' : ''} pending human review.
                      </div>
                      <Link
                        href="/review"
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            <DropdownMenuLabel>
              <div className="text-sm font-medium">Risk Admin</div>
              <div className="text-xs text-muted-foreground">
